...
class ParserTest(TestCase):
    ...
    ITEMS = [
        ...
        orm.PublicationType(PMID, 'publication type 1'),
        orm.PublicationType(PMID, 'publication type 2'),
        ...
        orm.Section(PMID, 13, 'PublisherAbstract', 'explanation for publisher abstract'),
        orm.Section(PMID, 14, 'NASAConclusions', 'NASA conclusions', 'NASA label'),
        orm.Section(PMID, 15, 'NASACopyright', 'NASA copyright'),
